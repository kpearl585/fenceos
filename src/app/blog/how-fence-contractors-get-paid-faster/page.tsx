...
export const metadata: Metadata = {
  title: "How Fence Contractors Get Paid Faster With Digital Estimates | FenceEstimatePro",
  description: "Digital estimates with e-signatures and deposit collection can cut your payment cycle from weeks to hours. Here\'s how fence contractors are using technology to get paid faster.",
  openGraph: {
    title: "How Fence Contractors Get Paid Faster With Digital Estimates",
    description: "Digital estimates with e-signatures and deposit collection can cut your payment cycle from weeks to hours.",
  },
};
        ...
        <div className="max-w-[680px] mx-auto" style={{ lineHeight: "1.8", fontFamily: "Inter, sans-serif" }}>
          ...
          <div className="bg-blue-50 border-l-4 border-blue-400 rounded-r-xl p-5 mb-10">
            <p className="text-blue-900 font-semibold text-lg m-0">
              The average fence contractor waits 14–21 days to collect a deposit. With digital estimates and e-signatures, that window shrinks to under 24 hours.
            </p>
          </div>
