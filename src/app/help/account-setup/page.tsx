    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-surface">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <h1 className="text-4xl font-bold text-text mb-3">Account Setup &amp; Team Management</h1>
          <p className="text-lg text-text/80">Configure your organization, add team members, and set permissions</p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <article className="prose prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Initial Account Setup</h2>
            ...
            <div className="bg-surface-2 border border-border rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-text mb-3">Step 1: Company Information</h3>
              <ul className="space-y-2 text-text/80">
                <li>
                  <strong className="text-text">Company Name:</strong> Legal business name (appears on proposals)
                </li>
                <li>
                  <strong className="text-text">Phone Number:</strong> Main business line (shown to customers)
                </li>
                <li>
                  <strong className="text-text">Email:</strong> Company email (for customer communication)
                </li>
                <li>
                  <strong className="text-text">Address:</strong> Physical business address (optional but recommended)
                </li>
                <li>
                  <strong className="text-text">Website:</strong> Your company website URL (if applicable)
                </li>
              </ul>
            </div>

            <div className="bg-surface-2 border border-border rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-text mb-3">Step 2: Branding</h3>
              <ul className="space-y-2 text-text/80">
                <li>
                  <strong className="text-text">Logo Upload:</strong> PNG or JPG, max 500KB, square aspect ratio recommended
                </li>
                <li>
                  <strong className="text-text">Brand Color:</strong> Primary color for proposals (hex code or color picker)
                </li>
                <li>
                  <strong className="text-text">Tagline:</strong> Optional slogan or mission statement
                </li>
              </ul>
            ...
            <div className="bg-surface-2 border border-border rounded-lg p-6">
              <h3 className="text-lg font-semibold text-text mb-3">Step 3: Default Settings</h3>
              <ul className="space-y-2 text-text/80">
                <li>
                  <strong className="text-text">Labor Rate:</strong> Your hourly labor rate (default: $50/hr)
                </li>
                <li>
                  <strong className="text-text">Markup Percentage:</strong> Default profit margin (typical: 25-30%)
                </li>
                <li>
                  <strong className="text-text">Waste Factor:</strong> Material waste percentage (default: 5-10%)
                </li>
                <li>
                  <strong className="text-text">Payment Terms:</strong> Deposit amount and payment schedule
                </li>
              </ul>
              <p className="text-text/80 text-sm mt-3">
          ...
          {/* Adding Team Members */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Adding Team Members</h2>
            <p className="text-text/80 mb-4">
              Pro and Business plans support multiple users. Add office staff, project managers, or field crew:
            </p>

            <div className="bg-surface-2 border border-border rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-text mb-3">How to Invite Team Members</h3>
              <ol className="list-decimal list-inside space-y-3 text-text/80">
                <li>Dashboard → Settings → Team</li>
                <li>Click <strong className="text-text">&quot;Invite Team Member&quot;</strong></li>
                <li>Enter their email address</li>
                <li>Select role (Admin, Estimator, or Viewer)</li>
                <li>Click <strong className="text-text">&quot;Send Invitation&quot;</strong></li>
            ...
            <p className="text-text/80 text-sm mb-6">
              💡 <strong className="text-text">Tip:</strong> Each team member gets their own login. No shared passwords.
              You can see who created/edited each estimate.
            </p>

            <div className="bg-surface-2 border border-border rounded-lg p-6">
              <h3 className="text-lg font-semibold text-text mb-3">User Limits by Plan</h3>
              <ul className="space-y-2 text-text/80">
                <li><strong className="text-text">Starter:</strong> 1 user (account owner only)</li>
                <li><strong className="text-text">Pro:</strong> Up to 3 users ($20/month each additional)</li>
                <li><strong className="text-text">Business:</strong> Unlimited users</li>
              </ul>
            </div>
          </section>
          ...
          {/* User Roles */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">User Roles &amp; Permissions</h2>

            <div className="grid md:grid-cols-3 gap-4 mb-6">
              {/* Admin */}
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Admin</h3>
                <p className="text-text/80 text-sm mb-4">
                  Full access to everything
                </p>
                <ul className="space-y-1 text-text/80 text-sm">
              ...
              {/* Estimator */}
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Estimator</h3>
                <p className="text-text/80 text-sm mb-4">
              ...
              {/* Viewer */}
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Viewer</h3>
                <p className="text-text/80 text-sm mb-4">
                  Read-only access
                </p>
                <ul className="space-y-1 text-text/80 text-sm">
            ...
            <p className="text-text/80 text-sm">
              <strong className="text-text">Common Setup:</strong> Owner = Admin, Office Manager = Estimator,
          ...
          {/* Managing Team */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Managing Your Team</h2>

            <div className="space-y-4">
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Changing a User&apos;s Role</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Removing a Team Member</h3>
                <p className="text-text/80 text-sm mb-3">
                  Settings → Team → Click user → Remove from Organization → Confirm
                </p>
                <p className="text-text/80 text-sm">
                  <strong className="text-text">What happens:</strong>
                </p>
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Viewing Team Activity</h3>
                <p className="text-text/80 text-sm">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Organization Settings</h2>

            <div className="space-y-4">
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Company Profile</h3>
                <p className="text-text/80 text-sm mb-3">
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Calculation Defaults</h3>
                <p className="text-text/80 text-sm mb-3">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Transferring Organization Ownership</h2>
            ...
            <div className="bg-surface-2 border border-border rounded-lg p-6">
              ...
              <ol className="list-decimal list-inside space-y-3 text-text/80">
                ...
                <li>Click <strong className="text-text">&quot;Transfer Ownership&quot;</strong></li>
              ...
              <p className="text-text/80 text-sm mt-4">
                <strong className="text-text">Note:</strong> Only the owner can manage billing and cancel subscription.
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">1. Limit Admin Access</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">2. Use Individual Logins</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">3. Onboard New Users</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">4. Regular Branding Review</h3>
                <p className="text-text/80 text-sm">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/help/getting-started" className="block p-6 bg-surface-2 border border-border rounded-lg hover:bg-surface-3 hover:border-accent/40 transition-all duration-150">
                ...
                <p className="text-text/80 text-sm">Ready to start estimating</p>
              </Link>
              <Link href="/help/pricing" className="block p-6 bg-surface-2 border border-border rounded-lg hover:bg-surface-3 hover:border-accent/40 transition-all duration-150">
                ...
                <p className="text-text/80 text-sm">Configure your material costs</p>
              </Link>
            </div>
          </section>
          ...
          <div className="mt-16 p-8 bg-accent/10 border border-accent/30 rounded-xl">
            <h3 className="text-xl font-bold text-text mb-2">Questions about account setup?</h3>
            <p className="text-text/80 mb-4">
