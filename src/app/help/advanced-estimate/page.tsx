    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-surface">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <h1 className="text-4xl font-bold text-text mb-3">Advanced Estimate Builder</h1>
          <p className="text-lg text-text/80">Master fence runs, gates, and complex configurations</p>
          <div className="mt-4 text-sm text-muted">8 min read</div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <article className="prose prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">When to Use Advanced Mode</h2>
          ...
          {/* Fence Runs */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Understanding Fence Runs</h2>
            <p className="text-text/80 mb-4">
              A <strong className="text-text">fence run</strong> is a continuous section of fence between corners or gates.
            ...
            <div className="bg-surface-2 border border-border rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-text mb-3">Example: L-Shaped Backyard</h3>
              <div className="space-y-3 text-text/80">
                <div>
                  <strong className="text-text">Run 1:</strong> Back property line (150 LF, 6&apos; privacy)
                </div>
                <div>
                  <strong className="text-text">Run 2:</strong> Left side yard (80 LF, 4&apos; picket)
                </div>
                <div>
                  <strong className="text-text">Run 3:</strong> Right side with gate (60 LF, 6&apos; privacy)
                </div>
              </div>
            </div>

            <h3 className="text-lg font-semibold text-text mb-3">Creating a Fence Run</h3>
            <div className="bg-surface-2 border border-border rounded-lg p-6">
              <ol className="list-decimal list-inside space-y-3 text-text/80">
                <li>Click <strong className="text-text">&quot;+ Add Fence Run&quot;</strong></li>
          ...
          {/* Gates */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Adding Gates</h2>
            <p className="text-text/80 mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div className="bg-surface-2 border border-border rounded-lg p-4">
                <h3 className="text-lg font-semibold text-text mb-2">Single Gates</h3>
                <ul className="space-y-2 text-text/80 text-sm">
                  <li><strong className="text-text">3&apos; wide:</strong> Standard walk-through</li>
                  <li><strong className="text-text">4&apos; wide:</strong> ADA compliant, wheelbarrows</li>
                  <li><strong className="text-text">5&apos; wide:</strong> Riding mower access</li>
                </ul>
              </div>

              <div className="bg-surface-2 border border-border rounded-lg p-4">
                <h3 className="text-lg font-semibold text-text mb-2">Double Gates</h3>
                <ul className="space-y-2 text-text/80 text-sm">
                  <li><strong className="text-text">8&apos;-10&apos; wide:</strong> Small vehicle access</li>
                  <li><strong className="text-text">12&apos;-14&apos; wide:</strong> Standard driveway</li>
                  <li><strong className="text-text">16&apos;+ wide:</strong> RV/boat access</li>
                </ul>
              </div>
            </div>

            <h3 className="text-lg font-semibold text-text mb-3">Gate Installation Considerations</h3>
            <div className="bg-surface-2 border border-border rounded-lg p-6">
              <ul className="space-y-3 text-text/80">
                <li>
                  <strong className="text-text">Post Sizing:</strong> Gates require larger/stronger posts (4x4&quot; minimum, 6x6&quot; for double gates)
                </li>
                <li>
                  <strong className="text-text">Hardware:</strong> Heavy-duty hinges, latches, drop rods for double gates
                </li>
                <li>
                  <strong className="text-text">Concrete:</strong> Extra concrete for gate posts (deeper holes, more mix)
                </li>
                <li>
                  <strong className="text-text">Labor Time:</strong> Gates take 2-4x longer than equivalent linear footage of fence
                </li>
                <li>
                  <strong className="text-text">Adjustments:</strong> Gates require precise leveling and swing clearance
                </li>
              </ul>
            </div>
          </section>
          ...
          {/* Material Overrides */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Material Overrides &amp; Adjustments</h2>
            <p className="text-text/80 mb-4">
            ...
            <div className="space-y-4">
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Waste Factor Adjustment</h3>
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Post Spacing Override</h3>
                <p className="text-text/80 mb-3">
                  Standard spacing is 8&apos; on-center. Adjust for:
                </p>
                <ul className="list-disc list-inside space-y-1 text-text/80 ml-4 text-sm">
                  <li><strong className="text-text">6&apos; spacing:</strong> High-wind areas, heavy gates nearby</li>
                  <li><strong className="text-text">10&apos; spacing:</strong> Commercial chain link (check local codes)</li>
                  <li><strong className="text-text">Irregular:</strong> Obstacles like trees, utilities, property corners</li>
                </ul>
              </div>

              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Concrete Quantity</h3>
                <p className="text-text/80 mb-3">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Terrain &amp; Site Conditions</h2>
            <p className="text-text/80 mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-surface-2 border border-border rounded-lg p-4">
                <h3 className="text-lg font-semibold text-text mb-2">Slopes</h3>
                <p className="text-text/80 text-sm mb-2">
                  <strong className="text-text">Stepped fence:</strong> Posts stay vertical, fence line steps down
                </p>
                <p className="text-text/80 text-sm">
                  <strong className="text-text">Racked fence:</strong> Fence line follows slope (limited to ~30° max)
                </p>
              </div>

              <div className="bg-surface-2 border border-border rounded-lg p-4">
                <h3 className="text-lg font-semibold text-text mb-2">Soil Type</h3>
                <p className="text-text/80 text-sm mb-2">
                  <strong className="text-text">Rocky:</strong> Requires rock removal, possibly drilling
                </p>
                <p className="text-text/80 text-sm">
                  <strong className="text-text">Clay:</strong> Difficult digging, may need gravel base
                </p>
              </div>

              <div className="bg-surface-2 border border-border rounded-lg p-4">
                <h3 className="text-lg font-semibold text-text mb-2">Obstacles</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-4">
                <h3 className="text-lg font-semibold text-text mb-2">Access</h3>
                <p className="text-text/80 text-sm">
            ...
            <p className="text-text/80 text-sm mt-4">
              💡 <strong className="text-text">Tip:</strong> Document these conditions in the estimate notes.
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Mixed Material Projects</h2>
            <p className="text-text/80 mb-4">
            ...
            <div className="space-y-4">
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Common Combinations</h3>
                <ul className="space-y-2 text-text/80 text-sm">
                  <li>
                    <strong className="text-text">Backyard privacy + front yard picket:</strong>
                    6&apos; wood/vinyl privacy fence in back, 3&apos;-4&apos; decorative picket in front
                  </li>
                  <li>
                    <strong className="text-text">Pool fence + perimeter fence:</strong>
                    4&apos; aluminum pool fence (code required), 6&apos; privacy around property line
                  </li>
                  <li>
                    <strong className="text-text">Chain link + wood gate:</strong>
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">How to Estimate Mixed Projects</h3>
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">1. Measure Twice, Build Once</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">2. Document Everything</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">3. Build in Contingency</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">4. Review Material Breakdown</h3>
                <p className="text-text/80 text-sm">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/help/export" className="block p-6 bg-surface-2 border border-border rounded-lg hover:bg-surface-3 hover:border-accent/40 transition-all duration-150">
                ...
                <p className="text-text/80 text-sm">Generate professional PDFs and Excel BOMs</p>
              </Link>
              <Link href="/help/pricing" className="block p-6 bg-surface-2 border border-border rounded-lg hover:bg-surface-3 hover:border-accent/40 transition-all duration-150">
                ...
                <p className="text-text/80 text-sm">Update prices and sync with suppliers</p>
              </Link>
            </div>
          </section>
          ...
          <div className="mt-16 p-8 bg-accent/10 border border-accent/30 rounded-xl">
            <h3 className="text-xl font-bold text-text mb-2">Questions about complex projects?</h3>
            <p className="text-text/80 mb-4">
