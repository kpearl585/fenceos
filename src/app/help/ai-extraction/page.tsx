    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-surface">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <h1 className="text-4xl font-bold text-text mb-3">AI Extraction from Customer Messages</h1>
          <p className="text-lg text-text/80">Automatically extract fence specs from emails and texts</p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <article className="prose prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">What is AI Extraction?</h2>
            ...
            <p className="text-text/80 text-sm mt-4">
              💡 <strong className="text-text">Time Savings:</strong> What takes 5-10 minutes to manually enter
          ...
          <section className="mb-12">
            ...
            <div className="bg-surface-2 border border-border rounded-lg p-6 mb-6">
              <ol className="list-decimal list-inside space-y-4 text-text/80">
                <li>
                  <strong className="text-text">Copy customer message:</strong> From email, text, or contact form
                </li>
                <li>
                  <strong className="text-text">Click &quot;AI Extract&quot;:</strong> Found in New Estimate screen
                </li>
                <li>
                  <strong className="text-text">Paste message:</strong> Into the text box
                </li>
                <li>
                  <strong className="text-text">AI processes:</strong> Extracts specs in ~5 seconds
                </li>
                <li>
                  <strong className="text-text">Review &amp; refine:</strong> Verify extracted data, fill any gaps
                </li>
                <li>
                  <strong className="text-text">Generate estimate:</strong> Proceed normally with pre-filled form
                </li>
              </ol>
            </div>
          </section>
          ...
          {/* Example Messages */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Example Messages That Work Well</h2>

            <div className="space-y-6">
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Example 1: Email Inquiry</h3>
                <div className="bg-black/30 rounded p-4 font-mono text-sm text-text/80 mb-4">
                ...
                <div className="text-sm">
                  <p className="text-text/80 mb-2"><strong className="text-text">AI Extracts:</strong></p>
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Example 2: Detailed Text Message</h3>
                <div className="bg-black/30 rounded p-4 font-mono text-sm text-text/80 mb-4">
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Example 3: Complex Requirements</h3>
                <div className="bg-black/30 rounded p-4 font-mono text-sm text-text/80 mb-4">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">What AI Can&apos;t Extract (Yet)</h2>
            <div className="bg-surface-2 border border-border rounded-lg p-6">
              <p className="text-text/80 mb-4">
              ...
              <ul className="space-y-3 text-text/80">
                <li>
                  <strong className="text-text">Vague descriptions:</strong> &quot;A fence for my house&quot; (no specs)
                </li>
                <li>
                  <strong className="text-text">Ambiguous footage:</strong> &quot;A big backyard&quot; (needs measurement)
                </li>
                <li>
                  <strong className="text-text">Missing contact info:</strong> Message doesn&apos;t include name/phone/email
                </li>
                <li>
                  <strong className="text-text">Conflicting info:</strong> Says 6 feet in one place, 5 feet in another
                </li>
                <li>
                  <strong className="text-text">Complex terrain:</strong> AI can note &quot;sloped&quot; but can&apos;t quantify angle
                </li>
                <li>
                  <strong className="text-text">Pricing expectations:</strong> AI extracts budget but doesn&apos;t validate feasibility
                </li>
              </ul>
            </div>
            <p className="text-text/80 text-sm mt-4">
              💡 <strong className="text-text">Pro Tip:</strong> Always review AI-extracted data before generating a proposal.
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Improving Extraction Accuracy</h2>

            <div className="space-y-4">
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">1. Include Full Message Context</h3>
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">2. Clean Up Formatting</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">3. Train Customers Over Time</h3>
          ...
          {/* Privacy & Security */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Privacy &amp; Security</h2>
            <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
              <p className="text-text/80 mb-4">
                <strong className="text-text">Your customer data is protected:</strong>
              </p>
              <ul className="space-y-2 text-text/80">
          ...
          {/* Troubleshooting */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Troubleshooting</h2>

            <div className="space-y-4">
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">AI extraction returns &quot;No data found&quot;</h3>
                <p className="text-text/80 text-sm">
                  <strong className="text-text">Solution:</strong> Message might be too vague or short.
                  Try pasting a longer message with more context, or manually enter the estimate details.
                </p>
              </div>

              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Extracted footage is way off</h3>
                <p className="text-text/80 text-sm">
                  <strong className="text-text">Solution:</strong> Customer may have stated footage ambiguously
                  (&quot;100 feet on each side&quot; could mean 100 total or 200 total). Always verify with customer before quoting.
                </p>
              </div>

              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Wrong fence type extracted</h3>
                <p className="text-text/80 text-sm">
                  <strong className="text-text">Solution:</strong> If customer said &quot;vinyl or wood, not sure,&quot;
                  AI picks one. You can easily change it in the form after extraction.
                </p>
              </div>

              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Extraction is slow or times out</h3>
                <p className="text-text/80 text-sm">
                  <strong className="text-text">Solution:</strong> Very long messages (multiple pages) can take 10-15 seconds.
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-4">
                <h3 className="text-md font-semibold text-text mb-2">✓ Do</h3>
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-4">
                <h3 className="text-md font-semibold text-text mb-2">✗ Don&apos;t</h3>
                <ul className="space-y-1 text-text/80 text-sm">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/help/getting-started" className="block p-6 bg-surface-2 border border-border rounded-lg hover:bg-surface-3 hover:border-accent/40 transition-all duration-150">
                ...
                <p className="text-text/80 text-sm">Manual estimate creation walkthrough</p>
              </Link>
              <Link href="/help/export" className="block p-6 bg-surface-2 border border-border rounded-lg hover:bg-surface-3 hover:border-accent/40 transition-all duration-150">
                ...
                <p className="text-text/80 text-sm">Generate PDFs and send to customers</p>
              </Link>
            </div>
          </section>
          ...
          <div className="mt-16 p-8 bg-accent/10 border border-accent/30 rounded-xl">
            <h3 className="text-xl font-bold text-text mb-2">AI extraction not working as expected?</h3>
            <p className="text-text/80 mb-4">
