    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="border-b border-border bg-surface">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <h1 className="text-4xl font-bold text-text mb-3">Data Export &amp; Backup</h1>
          <p className="text-lg text-text/80">Download your data, export estimates, and backup your account</p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <article className="prose prose-invert max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Your Data, Your Control</h2>
            ...
            <div className="bg-surface-2 border border-border rounded-lg p-6">
              <p className="text-text/80 mb-3">
                <strong className="text-text">What you can export:</strong>
              </p>
          ...
          {/* Full Account Export */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Full Account Data Export</h2>
            <p className="text-text/80 mb-4">
            ...
            <div className="bg-surface-2 border border-border rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-text mb-3">How to Export</h3>
              <ol className="list-decimal list-inside space-y-3 text-text/80">
                <li>Navigate to <strong className="text-text">Settings</strong> in the dashboard</li>
                <li>Scroll to <strong className="text-text">Data & Privacy</strong> section</li>
                <li>Click <strong className="text-text">&quot;Export All Data&quot;</strong></li>
            ...
            <div className="bg-accent/10 border border-accent/30 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-text mb-3">What&apos;s Included</h3>
              <div className="space-y-3 text-text/80">
                <div>
                  <strong className="text-text">Organization Info:</strong> Company name, settings, branding
                </div>
                <div>
                  <strong className="text-text">Estimates:</strong> All saved estimates with full input/output data
                </div>
                <div>
                  <strong className="text-text">Customers:</strong> Names, addresses, contact info, project history
                </div>
                <div>
                  <strong className="text-text">Materials:</strong> SKUs, prices, descriptions
                </div>
                <div>
                  <strong className="text-text">Settings:</strong> Labor rates, waste percentages, calibration data
                </div>
              </div>
            </div>

            <p className="text-text/80 text-sm">
              💡 <strong className="text-text">Tip:</strong> The export is in JSON format — readable by any programming language
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Exporting Individual Estimates</h2>
            <p className="text-text/80 mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-6">
              <div className="bg-surface-2 border border-border rounded-lg p-4">
                <h3 className="text-lg font-semibold text-text mb-2">PDF Proposal</h3>
                <p className="text-text/80 text-sm mb-3">Professional customer-facing document with:</p>
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-4">
                <h3 className="text-lg font-semibold text-text mb-2">Excel BOM</h3>
                <p className="text-text/80 text-sm mb-3">Internal bill of materials with:</p>
                <ul className="space-y-1 text-text/80 text-sm">
            ...
            <div className="bg-surface-2 border border-border rounded-lg p-6">
              <h3 className="text-lg font-semibold text-text mb-3">Export Steps</h3>
              <ol className="list-decimal list-inside space-y-2 text-text/80">
                <li>Open the estimate from your dashboard</li>
                <li>Click <strong className="text-text">&quot;Generate Customer Proposal&quot;</strong> or <strong className="text-text">&quot;Internal BOM&quot;</strong></li>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Backup Best Practices</h2>

            <div className="space-y-4">
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Monthly Full Export</h3>
                <p className="text-text/80 text-sm">
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Archive Completed Jobs</h3>
                <p className="text-text/80 text-sm">
                  After job completion, export the final estimate and proposal PDFs to a local folder structure:
                </p>
                <div className="bg-black/30 rounded p-4 font-mono text-sm text-text/80 mt-3">
                  <p>Completed Jobs/</p>
              ...
              <div className="bg-accent/10 border border-accent/30 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-3">Keep Offline Copies</h3>
                <p className="text-text/80 text-sm">
          ...
          {/* Data Portability */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">Data Portability</h2>
            <div className="bg-surface-2 border border-border rounded-lg p-6 mb-4">
              <p className="text-text/80 mb-4">
                Your data is yours. You can:
              </p>
              <ul className="space-y-2 text-text/80">
                <li>✓ <strong className="text-text">Export anytime:</strong> No restrictions, export hourly if needed</li>
                <li>✓ <strong className="text-text">No lock-in:</strong> Standard JSON format works anywhere</li>
                <li>✓ <strong className="text-text">Take it with you:</strong> If you leave FenceEstimatePro, your data comes too</li>
                <li>✓ <strong className="text-text">Import elsewhere:</strong> JSON can be converted to CSV, Excel, database formats</li>
              </ul>
            </div>
            <p className="text-text/80 text-sm">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-text mb-4">After Account Deletion</h2>
            <div className="bg-surface-2 border border-border rounded-lg p-6">
              <p className="text-text/80 mb-4">
              ...
              <ol className="list-decimal list-inside space-y-3 text-text/80">
                <li>
                  <strong className="text-text">30-day grace period:</strong> Data is marked for deletion but still recoverable
                  if you change your mind
                </li>
                <li>
                  <strong className="text-text">Export before deletion:</strong> We recommend exporting all data before
                  initiating account deletion
                </li>
                <li>
                  <strong className="text-text">Permanent deletion:</strong> After 30 days, all data is permanently deleted
                  and cannot be recovered
                </li>
                <li>
                  <strong className="text-text">No backups retained:</strong> We don&apos;t keep backups of deleted accounts
                </li>
              </ol>
            </div>
            <p className="text-text/80 text-sm mt-4">
              <Link href="/help/account-deletion" className="text-accent-light hover:text-accent-light">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Can I automate exports?</h3>
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">What format is the JSON export?</h3>
                <p className="text-text/80">
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Is there a size limit on exports?</h3>
                <p className="text-text/80">
              ...
              <div className="bg-surface-2 border border-border rounded-lg p-6">
                <h3 className="text-lg font-semibold text-text mb-2">Can I re-import exported data?</h3>
                <p className="text-text/80">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/help/account-deletion" className="block p-6 bg-surface-2 border border-border rounded-lg hover:bg-surface-3 hover:border-accent/40 transition-all duration-150">
                ...
                <p className="text-text/80 text-sm">How to delete your account and data retention policy</p>
              </Link>
              <Link href="/help/export" className="block p-6 bg-surface-2 border border-border rounded-lg hover:bg-surface-3 hover:border-accent/40 transition-all duration-150">
                ...
                <p className="text-text/80 text-sm">PDF and Excel export guide</p>
              </Link>
            </div>
          </section>
          ...
          <div className="mt-16 p-8 bg-accent/10 border border-accent/30 rounded-xl">
            <h3 className="text-xl font-bold text-text mb-2">Need help with data export?</h3>
            <p className="text-text/80 mb-4">
