    ...
    <div className="min-h-screen bg-fence-950">
      ...
      <div className="border-b border-white/10 bg-fence-900">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-3">Exporting Estimates (PDF & Excel)</h1>
          <p className="text-lg text-white/70">Generate professional proposals and internal BOMs</p>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <article className="prose prose-invert prose-fence max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Two Types of Exports</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-fence-500/10 border border-fence-500/30 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-white mb-3">Customer Proposal (PDF)</h3>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-white mb-3">Internal BOM (PDF)</h3>
                <p className="text-white/70 text-sm mb-4">
          ...
          {/* Customer Proposal */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Generating a Customer Proposal</h2>

            <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-white mb-3">Step-by-Step</h3>
              <ol className="list-decimal list-inside space-y-3 text-white/80">
                ...
                <li>Set your <strong className="text-white">markup percentage</strong> (this is your profit margin)</li>
            ...
            <h3 className="text-lg font-semibold text-white mb-3">What&apos;s Included in the Proposal</h3>
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-6">
              <ul className="space-y-3 text-white/80">
                <li>
                  <strong className="text-white">Header:</strong> Your company name, logo, contact info, proposal date
                </li>
                <li>
                  <strong className="text-white">Customer Details:</strong> Name, property address, contact info
                </li>
                <li>
                  <strong className="text-white">Project Scope:</strong> Fence type, linear feet, height, gates
                </li>
                <li>
                  <strong className="text-white">Pricing:</strong> Total bid price (materials + labor + markup)
                </li>
                <li>
                  <strong className="text-white">Timeline:</strong> Estimated start date and duration
                </li>
                <li>
                  <strong className="text-white">Warranty:</strong> 2-year workmanship warranty, manufacturer materials warranty
                </li>
                <li>
                  <strong className="text-white">Terms:</strong> Payment schedule, deposit requirements, change order policy
                </li>
                <li>
                  <strong className="text-white">Next Steps:</strong> Acceptance process and scheduling
                </li>
              </ul>
            </div>

            <p className="text-white/70 text-sm">
              💡 <strong className="text-white">Tip:</strong> Set your company branding in Settings → Company Profile
          ...
          {/* Internal BOM */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Generating an Internal BOM</h2>

            <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-white mb-3">Step-by-Step</h3>
              <ol className="list-decimal list-inside space-y-3 text-white/80">
                <li>Open your estimate from the dashboard</li>
                <li>Click <strong className="text-white">&quot;Generate Internal BOM&quot;</strong> or <strong className="text-white">&quot;Export BOM&quot;</strong></li>
                <li>PDF downloads with complete material breakdown</li>
                <li>Print for crew or use for material ordering</li>
              </ol>
            </div>

            <h3 className="text-lg font-semibold text-white mb-3">What&apos;s Included in the BOM</h3>
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-6">
              <div className="space-y-4 text-white/80">
                <div>
                  <strong className="text-white">Material Categories:</strong>
                  <ul className="list-disc list-inside ml-4 mt-2 text-sm text-white/70">
                ...
                <div>
                  <strong className="text-white">Cost Summary:</strong>
                  <ul className="list-disc list-inside ml-4 mt-2 text-sm text-white/70">
            ...
            <p className="text-white/70 text-sm">
              💡 <strong className="text-white">Tip:</strong> Print the BOM and keep it with your job folder.
          ...
          {/* Customization */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Customizing Your Proposals</h2>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">Warranty Information</h3>
                <p className="text-white/70 text-sm">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">1. Review Before Sending</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">2. Save Proposals with Estimates</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">3. Set Proposal Expiration</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">4. Use BOM for Ordering</h3>
                <p className="text-white/70 text-sm">
          ...
          {/* Troubleshooting */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Troubleshooting Export Issues</h2>

            <div className="space-y-4">
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-2">PDF doesn&apos;t download</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-2">PDF looks wrong when I open it</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-2">Logo doesn&apos;t appear in proposal</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-2">Export is very slow</h3>
                <p className="text-white/70 text-sm">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/help/getting-started" className="block p-6 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-fence-500/50 transition-all">
                ...
                <p className="text-white/70 text-sm">Learn how to build estimates before exporting</p>
              </Link>
              <Link href="/help/pricing" className="block p-6 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-fence-500/50 transition-all">
                ...
                <p className="text-white/70 text-sm">Update prices for accurate estimates</p>
              </Link>
            </div>
          </section>
          ...
          <div className="mt-16 p-8 bg-fence-500/10 border border-fence-500/20 rounded-xl">
            <h3 className="text-xl font-bold text-white mb-2">Problems with exports?</h3>
