    ...
    <div className="min-h-screen bg-fence-950">
      ...
      <div className="border-b border-white/10 bg-fence-900">
        <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-3">Material Price Management</h1>
          <p className="text-lg text-white/70">Update prices, sync with suppliers, and track costs</p>
          <div className="mt-4 text-sm text-white/50">7 min read</div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <article className="prose prose-invert prose-fence max-w-none">
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Why Price Management Matters</h2>
            <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6 mb-6">
              ...
              <ul className="space-y-2 text-white/80">
                <li>✓ <strong className="text-white">Avoid underbidding:</strong> Outdated prices = lost profit</li>
                <li>✓ <strong className="text-white">Stay competitive:</strong> Know your true costs</li>
                <li>✓ <strong className="text-white">Track price trends:</strong> See when materials spike</li>
                <li>✓ <strong className="text-white">Quote confidently:</strong> Real-time pricing in every estimate</li>
              </ul>
            </div>
          ...
          {/* Accessing Materials */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Accessing the Materials Manager</h2>
          ...
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Updating Individual Prices</h2>

            <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-white mb-3">Manual Price Update</h3>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-white mb-3">What to Update</h3>
              ...
              <ul className="list-disc list-inside space-y-2 text-white/70 ml-4 text-sm">
                <li><strong className="text-white">Posts:</strong> Wood 4x4, 6x6; vinyl line posts, terminal posts</li>
                <li><strong className="text-white">Rails:</strong> 2x4 rails, vinyl rails (per linear foot or per piece)</li>
                <li><strong className="text-white">Panels/Pickets:</strong> Vinyl panels, wood pickets, boards</li>
                <li><strong className="text-white">Concrete:</strong> 50lb bags, 60lb bags, 80lb bags</li>
                <li><strong className="text-white">Hardware:</strong> Screws (box price), hinges (per pair), latches</li>
                <li><strong className="text-white">Gates:</strong> Pre-fab gates (by size and material)</li>
              </ul>
            </div>
          </section>
          ...
          {/* Bulk Price Updates */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Bulk Price Updates</h2>

            <div className="space-y-4">
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">CSV Import (Pro & Business Plans)</h3>
                <p className="text-white/70 text-sm mb-3">
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">Percentage Increase/Decrease</h3>
                <p className="text-white/70 text-sm mb-3">
                ...
                <p className="text-white/70 text-sm mt-3">
                  <strong className="text-white">Example:</strong> Your lumber supplier raised all wood prices by 12%.
          ...
          {/* Supplier Sync */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Supplier Price Sync (Business Plan)</h2>

            <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-white mb-3">Automatic Price Updates</h3>
              <p className="text-white/80 mb-4">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-white mb-3">Supported Suppliers</h3>
              <p className="text-white/70 text-sm mb-3">
              ...
              <p className="text-white/70 text-sm mt-3">
                Contact <strong className="text-white">support@fenceestimatepro.com</strong> to set up supplier sync.
              </p>
            </div>
          </section>
          ...
          {/* Price History */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Price History &amp; Tracking</h2>

            <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-white mb-3">Viewing Price Changes</h3>
              <p className="text-white/70 text-sm mb-3">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6">
              ...
              <p className="text-white/70 text-sm">
                <strong className="text-white">Scenario:</strong> Customer from 3 months ago calls back to accept your quote.
          ...
          {/* Custom Materials */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Adding Custom Materials</h2>

            <div className="bg-white/5 border border-white/10 rounded-lg p-6 mb-6">
              <h3 className="text-lg font-semibold text-white mb-3">When to Add Custom Materials</h3>
              <ul className="list-disc list-inside space-y-2 text-white/70 ml-4 text-sm">
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-white mb-3">How to Add</h3>
              <ol className="list-decimal list-inside space-y-2 text-white/70 text-sm">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4">
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">1. Update Prices Before Quoting Season</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">2. Set Price Alerts</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">3. Include Your Markup in Pricing Strategy</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">4. Use Consistent Units</h3>
                <p className="text-white/70 text-sm">
              ...
              <div className="bg-fence-500/10 border border-fence-500/20 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">5. Factor in Delivery Costs</h3>
                <p className="text-white/70 text-sm">
          ...
          {/* Regional Pricing */}
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-white mb-4">Regional Pricing Variations</h2>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6">
              ...
              <ul className="space-y-2 text-white/80">
                <li>
                  <strong className="text-white">Urban vs. Rural:</strong> Materials 10-20% cheaper in rural areas (lower overhead)
                </li>
                <li>
                  <strong className="text-white">Coastal vs. Inland:</strong> Hurricane-rated materials cost more in coastal regions
                </li>
                <li>
                  <strong className="text-white">North vs. South:</strong> Treated lumber more expensive in wet/humid climates
                </li>
                <li>
                  <strong className="text-white">Freight Distance:</strong> Further from manufacturing = higher transport costs
                </li>
              </ul>
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <Link href="/help/getting-started" className="block p-6 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-fence-500/50 transition-all">
                ...
                <p className="text-white/70 text-sm">Use updated prices in your estimates</p>
              </Link>
              <Link href="/help/export" className="block p-6 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 hover:border-fence-500/50 transition-all">
                ...
                <p className="text-white/70 text-sm">Generate proposals with current pricing</p>
              </Link>
            </div>
          </section>
