  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="font-display text-3xl font-bold text-text mb-2">Terms of Service</h1>
        <p className="text-muted text-sm mb-12">Effective: {EFFECTIVE}</p>

        <div className="space-y-10 text-text/70 text-sm leading-relaxed">

          <section>
            <h2 className="text-text font-semibold text-lg mb-3">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">2. Description of Service</h2>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">3. Account Registration</h2>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">4. Subscription and Billing</h2>
            <p>FenceEstimatePro offers paid subscription plans. By subscribing, you authorize us to charge your payment method on a recurring basis. Plans are billed monthly or annually as selected. You may cancel at any time &mdash; cancellation takes effect at the end of the current billing period. No refunds are issued for partial periods.</p>
            <div className="mt-3 p-4 bg-surface-2 rounded-lg border border-border">
              <p className="font-medium text-text mb-2">Current Plans</p>
              <ul className="space-y-1 text-muted">
                <li>Starter &mdash; $49/month</li>
                <li>Pro &mdash; $89/month</li>
                <li>Business &mdash; $179/month</li>
              </ul>
            </div>
          </section>

          <section>
            <h2 className="text-text font-semibold text-lg mb-3">5. Acceptable Use</h2>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">6. Data and Privacy</h2>
            <p>Your use of the Service is also governed by our <Link href="/privacy" className="text-accent-light hover:text-accent underline">Privacy Policy</Link>. You retain ownership of all data you input into the Service. You grant us a limited license to process that data solely to provide and improve the Service. We do not sell your data to third parties.</p>
          </section>

          <section>
            <h2 className="text-text font-semibold text-lg mb-3">7. Confidentiality of Financial Data</h2>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">8. Disclaimers</h2>
            <p>The Service is provided &ldquo;as is&rdquo; without warranties of any kind. Estimate calculations are based on the inputs you provide &mdash; FenceEstimatePro does not guarantee the accuracy or profitability of any estimate. You are solely responsible for the quotes you provide to your customers.</p>
          </section>

          <section>
            <h2 className="text-text font-semibold text-lg mb-3">9. AI-Generated Estimates</h2>
            <p className="mb-3">The AI Photo Estimator generates fence estimates from photos using automated computer-vision analysis. These estimates are <span className="text-text">informational only</span> and are provided for convenience during the pre-bid stage.</p>
            <p className="mb-3">AI-generated estimates do <span className="text-text">not</span> constitute a professional bid, contract, warranty, or guarantee of any kind. Dimensions, fence types, gate counts, and price ranges are model-generated and may contain material errors. You must independently verify every measurement and product specification before relying on an AI estimate for any business decision, including but not limited to customer bids, material orders, permit applications, or job scheduling.</p>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">11. Termination</h2>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">12. Changes to Terms</h2>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">13. Governing Law</h2>
          ...
          <section>
            <h2 className="text-text font-semibold text-lg mb-3">14. Contact</h2>
            <p>Questions about these Terms? Contact us at <a href="mailto:support@fenceestimatepro.com" className="text-accent-light hover:text-accent">support@fenceestimatepro.com</a></p>
          </section>
        </div>
