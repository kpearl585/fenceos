...
export default function EstimatorFeedbackButton({ designId }: Props) {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 bg-blue-600 hover:bg-blue-700 text-white px-4 py-3 rounded-lg shadow-lg flex items-center gap-2 transition-colors z-50"
      >
  ...
  return (
    <div className="fixed bottom-6 right-6 bg-white rounded-lg shadow-xl w-96 max-w-[calc(100vw-3rem)] border border-gray-200 z-50">
      {/* Header */}
