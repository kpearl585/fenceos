...
export default function EstimatorFeedbackButton({ designId }: Props) {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 left-6 bg-blue-600 hover:bg-blue-700 text-white w-11 h-11 rounded-full shadow-lg flex items-center justify-center transition-colors z-40"
      >
  ...
  return (
    <div className="fixed bottom-6 left-6 bg-white rounded-lg shadow-xl w-96 max-w-[calc(100vw-3rem)] border border-gray-200 z-50">
      {/* Header */}
