    ...
    <section className="bg-surface px-6 py-20 md:py-24">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
          <div className="bg-danger/5 border border-danger/20 rounded-2xl p-7">
            ...
            <ul className="space-y-3 text-sm text-danger/70">
              <li className="flex items-start gap-2"><span className="mt-0.5">&bull;</span>Manual estimate: 45&ndash;60 min per job</li>
              <li className="flex items-start gap-2"><span className="mt-0.5">&bull;</span>Average underbid loss: $1,200 per job</li>
              <li className="flex items-start gap-2"><span className="mt-0.5">&bull;</span>Material miscounts: $200&ndash;$400 extra cost</li>
              <li className="flex items-start gap-2"><span className="mt-0.5">&bull;</span>Change orders: lose $400&ndash;$600 per incident</li>
              <li className="flex items-start gap-2 font-bold text-danger"><span className="mt-0.5">&bull;</span>Annual loss: $14,000&ndash;$28,000+</li>
            </ul>
          </div>
        ...
        <div className="bg-surface-2 border border-[rgba(255,255,255,0.07)] rounded-2xl p-8 text-center">
          ...
          <p className="text-muted">If it saves you from just one underbid job per month, you&apos;re up $1,200. That&apos;s $14,052 back in your pocket every year &mdash; for $348.</p>
          ...
          <p className="mt-3 text-muted text-xs">14-day free trial &middot; No credit card required</p>
        </div>
      </div>
    </section>
  );
