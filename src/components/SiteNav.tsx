          ...
          {checked && (
            loggedIn ? (
              ...
              <>
                ...
                <a href="#waitlist" className="bg-fence-600 text-white text-sm font-semibold px-4 py-2 rounded-lg hover:bg-fence-700 transition-colors">
                  Request Access →
                </a>
              </>
            )
          ...
          <div className="pt-2 border-t border-gray-100 flex flex-col gap-2">
            {checked && (loggedIn ? (
              ...
              <>
                ...
                <a href="#waitlist" className="block text-center bg-fence-600 text-white text-sm font-semibold px-4 py-2.5 rounded-lg">Request Access →</a>
              </>
            ))}
          </div>
        </div>
