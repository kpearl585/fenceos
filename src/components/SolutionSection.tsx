      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white">
            ...
            <span className="text-fence-400">built in</span> from the start
          </h2>
          <p className="mt-4 text-fence-300 max-w-xl mx-auto">Built specifically for fence contractors. Run-based geometry, real material math, margin protection — no spreadsheets required.</p>
        </div>
