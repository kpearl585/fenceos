    ...
    <section className="bg-surface py-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-muted text-lg max-w-2xl mx-auto mb-12">
          FenceEstimatePro is live and taking its first users. Built specifically for fence contractors &mdash; no fluff, no bloat, no generic features you&apos;ll never touch.
        </p>
        ...
        <p className="mt-4 text-sm text-muted">14-day free trial &middot; No credit card &middot; Cancel anytime</p>
      </div>
    </section>
  );
}
