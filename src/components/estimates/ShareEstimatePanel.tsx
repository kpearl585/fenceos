  ...
  return (
    <div className="bg-accent/5 border border-accent/20 rounded-xl p-5 mb-6">
      <div className="flex items-center gap-2 mb-3">
        ...
        <div>
          <h3 className="text-sm font-semibold text-text">Share with Customer</h3>
          <p className="text-xs text-muted">Customer views, signs &amp; accepts online — you get notified instantly</p>
        </div>
      </div>
      ...
      <div className="flex gap-2 mb-3">
        <input
          readOnly
          value={shareUrl}
          className="flex-1 text-xs bg-surface-3 border border-border rounded-lg px-3 py-2 text-muted truncate focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-colors duration-150"
      ...
      <form onSubmit={handleEmail} className="flex gap-2">
        <input
          ...
          className="flex-1 text-xs bg-surface-3 border border-border rounded-lg px-3 py-2 text-text placeholder:text-muted focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent transition-colors duration-150"
        />
        <button
          type="submit"
